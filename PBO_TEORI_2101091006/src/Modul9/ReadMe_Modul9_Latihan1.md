# Analisa Modul 9 Latihan1
#

Pada modul 9 program latihan1 menjelaskan beberapa point
1. Class
Class adalah sturktur dasa dari OOP. 
terdiri dari dua tipe dari anggota dimana disebut dengan field (attribut/properti) dan method. 
Field mespesifikasi tipe data yang didefinisikan oleh class, sementara methode spesifikasi dari operasi.
